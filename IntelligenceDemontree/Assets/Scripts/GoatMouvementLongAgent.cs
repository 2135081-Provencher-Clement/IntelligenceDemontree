...
/// <summary>
/// Deuxième cerveau de l'agent développé
/// 
/// Cherche à aller toucher une boule, mais esquive un ennemi en chemin
/// </summary>
public class GoatMouvementLongAgent : Agent
{
    ...
    /// <summary>
    /// Retire des points à l'agent s'il touche un mur ou un ennemi
    /// Termine l'épisode
    /// </summary>
